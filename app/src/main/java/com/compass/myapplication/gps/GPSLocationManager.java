package com.compass.myapplication.gps;
...
/**
 * Created by GUOSONGJIE on 2019/12/23.
 */
...
public class GPSLocationManager {
    ...
    public void start(GPSLocationListener gpsLocationListener, boolean isOpenGps) {
        ...
        locationManager.getBestProvider(createFineCriteria(),true); //Criteria类型对象，包含精度、是否返回高度、方位、速度等信息。
